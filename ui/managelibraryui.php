          ...
          <tbody>
             <tr>
               <!-- Remove Book -->
                <td colspan="1">
                  <h4>Remove Book</h4>
                   <form role="form" method="post" action="managelibrary.php">
                      <fieldset>
                         <div class="form-group">
                            <label class="col-md-5 control-label">Book ID</label>
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group">
                                 <span class="input-group-addon">
                                   <i class="glyphicon glyphicon-user"></i>
                                 </span>
                                 <input id="deleteBookID" name="deleteBookID" placeholder="Book ID" class="form-control" required="true" value="" type="text">
                               </div>
                            </div>
                         </div>
                         <div>
                  ...
                  <h4>Change Role</h4>
                   <form role="form" method="post" action="managelibrary.php">
                      <fieldset>
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                 <input id="userID" name="userID" placeholder="User ID" class="form-control" required="true" value="" type="text"></div>
                            </div>
                         </div>
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group">
                                  ...
                                  <select class="selectpicker form-control" name = "rolenumber" id = "rolenumber">
                         ...
                         <div>
            									  <input type="submit" class="btn btn-lg btn-info" value="Change Role">
            							</div>
                      </fieldset>
                   </form>
                </td>
